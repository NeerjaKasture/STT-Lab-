...
PlayAgain:
	...
	{
		Width = Console.WindowWidth = 30; // Bug 3: Changed window size
	...
	while (true)
	{
		...
		// Updates
		{
			// Pipes
			{
				...
				if (PipeFrame >= SpaceBetweenPipes - 25 ) // Bug 2: Pipes spawn too frequently
			...
			// Bird
			{
				...
				BirdY += BirdDY;
				BirdDY -= Gravity; // Bug 1: Should be += Gravity
